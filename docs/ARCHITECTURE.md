...
| v0.5.16 `/pinrule <natural language>` skill actually works — first release; multi-backend install (Claude Code / Codex / Cursor); v0.5.1-15 honest disclosure (wrong install path → skill never triggered before) | ✅ |
