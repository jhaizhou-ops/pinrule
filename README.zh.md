...
**目录**：[痛点](#你遇到的真问题) · [10 秒上手](#0-依赖纯工程10-秒上手) · [`/karma` 自然语言录入规则](#karma-自然语言--agent-替你写规则) · [使用效果](#使用效果) · [原理](#为什么有效) · [性能](#性能量化对照) · [8 个 hook 全面监管](#8-个-hook-位置全面监管) · [自定义规则](#自定义你自己的核心方向) · [karma 不做的事](#试过但放弃的karma-不做的事) · [FAQ](#faq) · [文档导航](#文档导航)
...
```
你（在 Claude Code 里）：/karma 我说「完成」的时候希望真附测试通过证据
                       不要接受模糊的「应该可以」声明
