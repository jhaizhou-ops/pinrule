...
当前 `data/sticky.dev.example.yaml` 是「**软件开发场景**」预设 — 6 条规则全部针对写代码时的注意力漂移（长期方案 / 不阻塞 / 完成证据 / 不喂测试集 / 先读再写 / 直白中文）。工程层 6 个 violation_check 函数（pytest / Edit / Write / Bash 等）也偏开发场景。
